...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/nios_system_rsp_xbar_demux_002.sv"                       -work rsp_xbar_demux_002                                                                  
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/nios_system_id_router_005.sv"                            -work id_router_005                                                                       
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                            -work nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                     -work nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                           -work nios2_processor_data_master_translator_avalon_universal_master_0_agent              
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                       -work nios2_processor_jtag_debug_module_translator                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                      -work nios2_processor_data_master_translator                                              
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L irq_mapper -L width_adapter -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_002 -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L burst_adapter -L limiter -L id_router_005 -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_processor_data_master_translator_avalon_universal_master_0_agent -L nios2_processor_jtag_debug_module_translator -L nios2_processor_data_master_translator -L to_cpu_ACK -L to_fsm_ACK -L character_lcd_0 -L jtag_uart -L control_words -L keys -L onchip_memory -L nios2_processor -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L irq_mapper -L width_adapter -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_002 -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L burst_adapter -L limiter -L id_router_005 -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_processor_data_master_translator_avalon_universal_master_0_agent -L nios2_processor_jtag_debug_module_translator -L nios2_processor_data_master_translator -L to_cpu_ACK -L to_fsm_ACK -L character_lcd_0 -L jtag_uart -L control_words -L keys -L onchip_memory -L nios2_processor -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
